          ...
          <div className="max-w-[1600px] mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="text-xs text-text-secondary whitespace-nowrap">
                ...
                <span className="text-text-tertiary"> of {totalGames} picks</span>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              {isComplete && (
                <button
                  onClick={handleShare}
                  className="flex items-center gap-1 px-2 py-1.5 text-xs bg-brand-primary text-on-brand-primary rounded-md hover:bg-brand-primary-hover transition-colors"
                >
                  <Share2 size={14} />
